...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Channel', url='https://t.me/Bangladeshhoarding'),
            InlineKeyboardButton('🧩 Error', url='https://t.me/A6J1L_Aka_Alex_Stuart')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Error', url='https://t.me/A6J1L_Aka_Alex_Stuart'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Bangladeshhoarding'),     
        ],
        [
            InlineKeyboardButton("🎞 Index", url='https://mirror.indexbd.cf/1:/'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>☀️🙃☀️.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
